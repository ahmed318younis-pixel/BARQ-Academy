...
- Evidence / commit: To be linked to the implementation commit.
...
- Evidence / commit: `validate.py` and the failure/recovery test; commit to be linked after implementation commit.
...
- Evidence / commit: Docker Compose network configuration and manual negative connectivity test; commit to be linked after implementation commit.
...
- Evidence / commit: Backup/restore and persistence tests; commit to be linked after implementation commit.
...
- Evidence / commit: `docker-compose.yml` health-based `depends_on`; commit to be linked after implementation commit.
...
- Evidence / commit: Docker Compose configuration and container inspection; commit to be linked after implementation commit.
...
- Evidence / commit: Dockerfile and `docker exec app-01 id`; commit to be linked after implementation commit.
...
- Evidence / commit: Dockerfile, `.gitignore`, `.env.example`, and Compose configuration; commit to be linked after implementation commit.
